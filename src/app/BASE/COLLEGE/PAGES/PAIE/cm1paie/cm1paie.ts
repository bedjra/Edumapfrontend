...
@Component({
  selector: 'app-cm1paie',
  imports: [CommonModule, FormsModule, NgbModule, HttpClientModule, RouterLink],
  templateUrl: './cm1paie.html',
  styleUrl: './cm1paie.css'
})
export class Cm1paie implements OnInit {
  classe: string = 'CM1'; // ou dynamique selon ton contexte
  ...
  ngOnInit(): void {
    if (typeof window !== 'undefined') {
      ...
      setTimeout(() => {
        this.chargerPaiements(ClassePRIMAIRE.CM1);
      }, 200);
