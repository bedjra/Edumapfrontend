...
@Component({
  selector: 'app-cm2paie',
  imports: [CommonModule, FormsModule, NgbModule, HttpClientModule, RouterLink],
  templateUrl: './cm2paie.html',
  styleUrl: './cm2paie.css',
})
export class Cm2paie implements OnInit {
  classe: string = 'CM2'; // ou dynamique selon ton contexte
  ...
  ngOnInit(): void {
    if (typeof window !== 'undefined') {
      ...
      setTimeout(() => {
        this.chargerPaiements(ClassePRIMAIRE.CM2);
      }, 200);
