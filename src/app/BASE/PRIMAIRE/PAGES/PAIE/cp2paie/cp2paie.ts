...
@Component({
  selector: 'app-cp2paie',
  imports: [CommonModule, FormsModule, NgbModule, HttpClientModule, RouterLink],
  templateUrl: './cp2paie.html',
  styleUrl: './cp2paie.css',
})
export class Cp2paie implements OnInit {
  classe: string = 'CP2'; // ou dynamique selon ton contexte
  ...
  ngOnInit(): void {
    if (typeof window !== 'undefined') {
      ...
      setTimeout(() => {
        this.chargerPaiements(ClassePRIMAIRE.CP2);
      }, 200);
